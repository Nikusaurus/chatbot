...
def methodology():
    ...
    # Display the image
    image_url = "https://i.postimg.cc/K8mpSLfp/use-case-1.jpg"
    ...
    # Display the image
    image_url = "https://i.postimg.cc/q7RmgT98/use-case-2.jpg"
    ...
    st.image(image_url, caption="Use Case 3", use_column_width=True)
